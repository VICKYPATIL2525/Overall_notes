...
> - Set up your app as a background service — see [01_systemd_app_service.md](../01_linux-deployment/01_systemd_app_service.md)
> - Expose it via Nginx — see [02_nginx_setup.md](../01_linux-deployment/02_nginx_setup.md)
...
> If you are using Nginx as a reverse proxy (recommended), you only need ports 22, 80, and 443 open. Your app's internal port does not need to be exposed — see [02_nginx_setup.md](../01_linux-deployment/02_nginx_setup.md).
